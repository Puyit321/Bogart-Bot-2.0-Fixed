...
console.log(boldText(gradient.cristal("║ • JONELL MAGALLANES SUPOT")));
console.log(boldText(gradient.cristal("║ • ARJHIL DUCAYANAN SUPOT")));
console.log(boldText(gradient.cristal("║ • JAY MAR SUPOT")));
console.log(boldText(gradient.cristal("║ • JR BUSACO SUPOT")));
console.log(boldText(gradient.cristal("║ => MGA SUPOT SA: CHATBOT COMMUNITY")));
console.log(boldText(gradient.cristal("╚════════════════════")));
